...
<div class="card">
    <div class="card-body">
        {!! Form::model($product, ['route' => ['admin.products.update',$product], 'method' => 'put', 'files' => true, 'autocomplete' => 'off']) !!}
        <div class="form-group">
            <div class="row ">
                 <div class="col m-2">
                         {!! Form::label('product_name', 'Nombre del producto: ') !!}
                         {!! Form::text('product_name', null, ['class' => 'form-control' . ($errors->has('product_name') ? ' is-invalid' : ''), 'placeholder' => 'Escriba un nombre', 'autocomplete' => 'off']) !!}
                         @error('product_name')
                 ...
                 <div class="col m-2">
                         ...
                         {!! Form::text('product_code', null, ['class' => 'form-control' . ($errors->has('product_code') ? ' is-invalid' : ''), 'placeholder' => 'Escriba el codigo', 'autocomplete' => 'off']) !!}
                         @error('product_code')
                             <div class="alert alert-danger mt-1" role="alert">
                             <strong>Ups!</strong>{{$message}}
                             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
            ...
            <div class="row">
                 <div class="col m-2">
                     {!! Form::label('product_details', 'Detalle del producto: ') !!}
                         {!! Form::textarea('product_details', null, ['class' => 'form-control' . ($errors->has('product_details') ? ' is-invalid' : ''), 'placeholder' => 'Escriba una cantidad', 'autocomplete' => 'off', 'rows' => '2']) !!}
            ...
            <div class="row ">
                 <div class="col m-2">
                         ...
                         {!! Form::text('product_quantity', null, ['class' => 'form-control' . ($errors->has('product_quantity') ? ' is-invalid' : ''), 'placeholder' => 'Escriba una cantidad', 'autocomplete' => 'off']) !!}
                 ...
                 <div class="col m-2">
                         ...
                         {!! Form::text('selling_price', null, ['class' => 'form-control' . ($errors->has('selling_price') ? ' is-invalid' : ''), 'placeholder' => 'Escriba un precio', 'autocomplete' => 'off']) !!}
                         @error('selling_price')
                             <div class="alert alert-danger mt-1" role="alert">
                             <strong>Ups!</strong>{{$message}}
                             <button type="button" class="close" data-dismiss="alert" aria-label="Close">
        ...
        <hr>
         ...
         <div class="form-group row">
             <div class="col-3 m-2">
                 ...
                 {!! Form::text('product_color', null, ['data-role' => 'tagsinput', 'class' => 'form-control' . ($errors->has('product_color') ? ' is-invalid' : ''), 'autocomplete' => 'off']) !!}
               
             </div>
             <div class="col-3 m-2">
                 {!! Form::label('product_size', 'Talla/tamaño: ') !!}
                 {!! Form::text('product_size', null, ['data-role' => 'tagsinput','class' => 'form-control' . ($errors->has('product_size') ? ' is-invalid' : ''),  'autocomplete' => 'off']) !!}
                 <style>
                     .tag{
             ...
             <div  class="col-2">
                <img style="border-radius: 8px;" src="{{Storage::url($product->image_one)}}" width="100%" alt="">
             </div>
