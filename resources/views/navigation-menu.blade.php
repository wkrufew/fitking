...
@endphp
<div style="z-index: 999" class="w-full -mt-1 md:mt-0 bg-transparent fixed top-0 left-0 px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-0 xl:py-4 transition-all duration-500 ease-in" id="navbar">
    <nav x-data="{ open: false }" class="">
            ...
            <div class="flex justify-between h-16">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex ">
                    ...
                    <x-jet-nav-link href="{{route('contact')}}" :active="request()->routeIs('contact')">
                        <div  class="text-gray-50 text-md hover:text-yellow-500">CONTACTANOS </div>
                    </x-jet-nav-link>  
                </div>
        ...
        <div :class="{'block': open, 'hidden': ! open}" class="bg-gray-100 rounded-lg hidden sm:hidden mb-6 border-2 border-yellow-500">
            <div class="pt-2 pb-3 space-y-1">
                ...
                <x-jet-responsive-nav-link href="{{route('tienda')}}">
                ...
                <x-jet-responsive-nav-link href="{{route('contact')}}" :active="request()->routeIs('contact')">
                    <div  class="text-gray-600 text-md hover:text-yellow-500">CONTACTANOS</div>
                </x-jet-responsive-nav-link>
