<x-app-layout>
    <section class="bg-black">
        <div class=" py-24 bg-cover bg-black mt-0" style="background-color: black;  background-image: url({{asset('img/home/sports.jpg')}})">
    ...
    <section>
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <h1 class="text-gray-600 text-2xl font-bold mb-2">Detalles de la compra</h1>  
                ...
                <div class="card">
                    <div class="card-body">
                        <div class=" object-center justify-items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-x-1 gap-y-6 ">
                            <div class="col-1">
                                <img class="shadow-lg rounded-lg w-full h-24 object-cover" src="{{Storage::url($plan->image->url)}}" alt="">
                            </div>
                            <div class="col-span-2">
                                <h1 class="text-gray-600 font-bold text-xl ml-4 uppercase text-justify">{{$plan->title}}</h1>
                            </div>
                            <div class="col-1">
                                <p class="font-bold text-2xl ml-auto text-green-600">$  {{$plan->price->value}}</p>
                            </div>
                        ...
                        <div class="object-center justify-items-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-x-1 gap-y-6 ">
                            ...
                            <div class="my-auto rounded-full">
                                <a href="{{route('payment.cash', $plan)}}" class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110 center py-3 px-5 bg-blue-500 text-white font-semibold rounded-full shadow-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-opacity-75">
                        ...
                        <hr class="my-4">
                        <h1 style="font-size: 70%" class=" text-gray-500 text-justify"><b>Nota:&nbsp;</b>Al aceptar comprar el plan no se receptaran devoluciones, 
