...
<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="fondo m-6 py-4 md:py-6 px-6 rounded-md text-center">
            <span class="text-center text-white font-semibold text-2xl">
