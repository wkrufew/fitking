...
<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto">
        <div class="fondo m-4 py-4 md:py-10 px-3 md:px-6 rounded-md text-center">
            <span class="text-center text-white font-semibold text-base md:text-2xl">
                {{ __('LISTADO DE PLANES QUE TIENE FITKING PARA OFRECERTE') }}
            </span>
            <div class="max-w-lg mx-auto pt-2 {{-- bg-white py-2 px-1 md:px-6 rounded-md shadow-lg --}}">
                @livewire('search')
            </div>
        </div>
    </div>

    {{--  <div class="w-full md:max-w-3xl mx-auto px-1 mb-5">
        <div class="">
            @livewire('search')
        </div>
    </div> --}}
    <div class="max-w-7xl mx-auto pb-6 px-2">
        @livewire('plan-index')
    </div>
</x-app-layout>
