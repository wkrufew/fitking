<x-app-layout>
    ...
    <div id="fitking"></div>
    <section class="bg-black pt-0 md:pt-24 select-none">
        <div class="py-3">
        ...
        <div
            ...
            <article>
                <figure>
                    <img class="rounded-xl h-144 w-full object-cover" src="{{ asset('img/home/sports.jpg') }}"
                        alt="img-propietario">
                </figure>
            </article>
            <article class="my-auto">
                ...
                <p class="text-center text-base px-1 md:px-10 md:text-2xl mt-2 md:mt-4 text-gray-300">Joven deportista ,
                    con 22
    ...
    <section class="bg-black select-none">
        <div class="py-6">
        ...
        <div
            ...
            <article class="transition duration-500 ease-in-out transform hover:-translate-y-1 hover:scale-110">
                ...
                <header class="mt-2">
                    <h1 class="text-center font-bold mt-2 mb-1 text-lg text-gray-200 px-10">PLAN NUTRICIONAL
                    </h1>
                </header>
            ...
            <article
                ...
                <header class="mt-2">
                    <h1 class="text-center mt-2 font-bold mb-1 text-lg text-gray-200 px-10">ENTRENAMIENTO</h1>
                </header>
            ...
            <article
                ...
                <header class="mt-2">
                    <h1 class="text-center mt-2 mb-1 font-bold text-lg text-gray-200 px-0">SEGUIMIENTO
                        PERSONALIZADO</h1>
                </header>
            ...
            <article
                ...
                <header class="mt-2">
                    <h1 class="text-center mt-2 font-bold mb-1 text-xl text-gray-200 px-2">VIDEOS INSTRUCTIVOS
                    </h1>
                </header>
    ...
    <section class="bg-black py-28 md:py-36 px-6 select-none">
        <h1
        ...
        <p
            ...
            Ve al catalogo de planes y elije el mejor y empieza ahora.
        </p>
    ...
    <section class="pb-10 relative  bg-white select-none">
    ...
    <section class="pb-16 bg-white select-none">
        ...
        <div
            ...
            <article>
                ...
                <header>
                    <h1 class="my-2 text-center font-bold text-lg text-gray-700 px-10">Proton Whey
                    </h1>
                </header>
