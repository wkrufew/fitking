 <form class="pt-2 relative mx-auto text-gray-600" autocomplete="off">
     <input wire:model="search" class="w-full border-2 rounded-full border-gray-300 bg-white h-12 px-5 pr-16 text-sm " type="search" name="search" placeholder="Busca un plan">
         ...
         <ul class="absolute left-0 w-full bg-white mt-1 rounded-2xl overflow-hidden z-50">
            <div wire:loading wire:target="search" class=" p-4 w-full mx-auto">
             ...
             @forelse ($this->results as $result)
                 <li class="leading-8 px-5 text-sm cursor-pointer hover:bg-yellow-500 hover:text-white">
