<section class="pb-6">
    <h1 class="font-bold text-blue-500 text-lg md:text-xl mb-2 mt-0">Valoraciones</h1>
        ...
        <article class="mb-3">
            ...
            @else 
                <div class="rounded-lg flex items-center bg-blue-500 text-white text-sm font-bold px-4 py-3" role="alert">
                    ...
                    <p class="text-xs md:text-base">Has realizado la valoracion del plan con exito</p>
                </div>   
            @endcan
        </article>
    @else
        ...
        <div class="mb-2 px-4 py-3 leading-normal text-blue-500 bg-white rounded-lg" role="alert">
            <p class="text-xs md:text-base"><b>Nota: </b> Para realizar una valoracion del plan debes estar matriculado</p>
        </div>
