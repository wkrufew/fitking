        ...
        <article class="mb-3">
            ...
            @else 
                <div class="rounded-lg flex items-center bg-black text-white text-sm font-bold px-4 py-3" role="alert">
                    ...
                    <p class="text-xs md:text-base">Ha realizado la calificación con éxito</p>
                </div>   
            @endcan
        </article>
    @else  
                ...
                <div class="card flex-1 ml-1">
                    <div class="px-2 py-2 md:px-4 md:py-3 bg-white relative ">
                        ...
                        @if ($review->user_id ==  Auth::id())
                            <div class="flex absolute right-0 top-0{{--  md:right-1 md:top-1 --}} cursor-pointer">
                                ...
                                <div x-data="{ isOpen: false }" class="relative inline-block">
                                    ...
                                    <div x-show="isOpen" 
                                        ...
                                        {{-- <span class="text-neutral-500 text-xs px-4">Opciones</span> --}}
