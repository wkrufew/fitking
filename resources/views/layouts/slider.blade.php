...
<div class="banner">
    ...
    <div class="container fill_height">
        <div class="row fill_height">
            <div class="banner_product_image"><img src="{{ Storage::url($slider->image_one) }}" alt=""
            ...
            <div class="col-lg-5 offset-lg-4 fill_height">
                <div class="banner_content">
                    ...
                    <div class="button banner_button">{{-- <a href="#">Compra ahora</a> --}}
                        <a href="#" id="{{ $slider->id }}" class=" addcart" data-toggle="modal"
                            data-target="#cartmodal" onclick="productview(this.id)">Añadir al carrito</a>
                    </div>
                </div>
            </div>
        </div>
